 ...
 * which allows easy control over the apparently submitted bindings and URL information.
 * These are dispensed from the {@link PlainRSFTests} class which is assumed
 * to be the base class for the test class being written. Each RequestLauncher
 * object corresponds to a single RSAC cycle.
 * 
