 ...
 * 
 */
public class ViewParametersFactory 
  implements HttpServletRequestAware, FactoryBean, Copiable {
  ...
  public Object copy() {
    ViewParametersFactory togo = new ViewParametersFactory();
    togo.vpexemplar = vpexemplar;
    return togo;
  }
  ...
  public static ViewParameters parseRequest(HttpServletRequest request, 
    ...
    // request.
    ViewParameters origrequest = (ViewParameters) vpexemplar.copy();
  ...
  public Object getObject() throws Exception {
    if (viewparams == null) {
      ...
      else { // we are probably a dead bean.
        viewparams = new BlankViewParameters();
      }
    }
    return viewparams;
  }
