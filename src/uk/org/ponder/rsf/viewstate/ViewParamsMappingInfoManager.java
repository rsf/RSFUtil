...
public class ViewParamsMappingInfoManager {
  ...
  private String inferDefaultParseSpec(ViewParameters viewparams) {
    MethodAnalyser methodAnalyser = mappingcontext.getAnalyser(viewparams
        .getClass());
  ...
  private ViewParamsMapInfo computeMappingInfo(ViewParameters viewparams) {
    ...
    // added this so we can avoid boilerplate code in viewparams
    ...
    if (parsespecaccess.getDeclaringClass() == SimpleViewParameters.class) {
      ...
      // getParseSpec is overridden so call it
