...
public class ViewParamsMappingInfoManager {
   ...
   */
  private String createParseSpec(ViewParameters viewparams) {
  ...
  private ViewParamsMapInfo computeMappingInfo(ViewParameters viewparams) {
    ...
    AccessMethod am = ma.getAccessMethod("parseSpec");
    String spec = "";
    if ( am.getDeclaringClass() == SimpleViewParameters.class ) {
    	...
    	spec = createParseSpec(viewparams);
    } else {
