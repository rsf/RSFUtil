...
/**
 * Manages inferred information relating to the mapping of ViewParameters objects
 * onto a URL structure.<br/> 
 * <b>WARNING:</b> <i>NEVER</i> place RSF at a shared classloader level or
...
public class ViewParamsMappingInfoManager {
  ...
  /**
   * Takes a path ending with a greedy expression (probably .*) and appends
   * the "leaves" (fields) based on passed in arguments
   */
