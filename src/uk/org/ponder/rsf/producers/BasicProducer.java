 ...
 * half-constructed JointContainer as the 2nd argument indicating the desired
 * client ID. This is suitable, for example, for accepting the page body
 * from a main ViewProducer.
 * 
